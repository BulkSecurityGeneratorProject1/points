...
describe('Points e2e test', () => {
    ...
    it('should load Points', async () => {
        ...
        expect(await pointsComponentsPage.getTitle()).to.eq('pointsApp.points.home.title');
    });
    ...
    it('should load create Points page', async () => {
        ...
        expect(await pointsUpdatePage.getPageTitle()).to.eq('pointsApp.points.home.createOrEditLabel');
    ...
    it('should create and save Points', async () => {
        ...
        await promise.all([
            ...
            pointsUpdatePage.user_pointSelectLastOption()
        ]);
    ...
    it('should delete last Points', async () => {
        ...
        expect(await pointsDeleteDialog.getDialogTitle()).to.eq('pointsApp.points.delete.question');
